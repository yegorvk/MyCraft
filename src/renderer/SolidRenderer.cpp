...
void SolidRenderer::reset(glm::ivec3 newActiveRegionMin, glm::ivec3 newActiveRegionSize) {
...
void SolidRenderer::update(glm::ivec3 chunkPos, const ChunkMeshData *meshData) {
...
void
SolidRenderer::draw(glm::dvec3 cameraPosition, const glm::mat4 &viewProjection, const ViewFrustrum &frustrum) const {
    shader->bind();
